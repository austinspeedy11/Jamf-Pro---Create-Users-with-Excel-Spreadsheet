...
sheetNames = []
for i in range(sheet.nrows -1):
	sheetNames.append((sheet.cell_value(i + 1, 0)))
		
sheetFullNames = []
for i in range(sheet.nrows -1):
	sheetFullNames.append((sheet.cell_value(i + 1, 1)))
	
sheetEmails = []
for i in range(sheet.nrows -1):
	sheetEmails.append((sheet.cell_value(i + 1, 2)))

sheetPhoneNumbers = []
for i in range(sheet.nrows -1):
	sheetPhoneNumbers.append((sheet.cell_value(i + 1, 3)))
		
sheetPositions = []
for i in range(sheet.nrows -1):
	sheetPositions.append(sheet.cell_value(i + 1, 4))
